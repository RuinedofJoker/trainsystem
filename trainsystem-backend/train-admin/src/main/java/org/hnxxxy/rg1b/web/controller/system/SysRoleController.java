...
import org.hnxxxy.rg1b.common.core.domain.entity.SysDept;
...
import org.hnxxxy.rg1b.system.domain.SysUserRole;
import org.hnxxxy.rg1b.system.service.ISysDeptService;
import org.hnxxxy.rg1b.system.service.ISysRoleService;
...
public class SysRoleController extends BaseController
{
    ...
    @ApiOperation("条件分页查询所有角色信息")
    @ApiImplicitParam(name = "role",value = "角色信息查询条件",dataType = "SysRole",dataTypeClass = SysRole.class)
    ...
    @ApiOperation("export")
    @ApiImplicitParam(name = "role",value = "用户信息查询条件",dataType = "SysUser",dataTypeClass = SysUser.class)
     ...
     */
    @ApiOperation("remove")
    @ApiImplicitParam(name = "roleIds",value = "角色ids",dataType = "Long[]",dataTypeClass = Long[].class)
     ...
     * 批量取消授权用户
     */
    @ApiOperation("cancelAuthUserAll")
    @ApiImplicitParams({
        @ApiImplicitParam(name = "roleId",value = "角色id",dataType = "Long",dataTypeClass = Long.class),
        @ApiImplicitParam(name = "userIds",value = "用户ids",dataType = "Long[]",dataTypeClass = Long[].class)
    })
    @PreAuthorize("@ss.hasPermi('system:role:edit')")
    @Log(title = "角色管理", businessType = BusinessType.GRANT)
     ...
     * 批量选择用户授权
     */
    @ApiOperation("selectAuthUserAll")
    @ApiImplicitParams({
        @ApiImplicitParam(name = "roleId",value = "角色id",dataType = "Long",dataTypeClass = Long.class),
        @ApiImplicitParam(name = "userIds",value = "用户ids",dataType = "Long[]",dataTypeClass = Long[].class)
    })
