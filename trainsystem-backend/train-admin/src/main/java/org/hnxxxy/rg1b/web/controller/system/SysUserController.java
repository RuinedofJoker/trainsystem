...
import org.hnxxxy.rg1b.system.service.ISysPostService;
...
public class SysUserController extends BaseController
{
    ...
    @ApiOperation("importData")
    @ApiImplicitParams({
        @ApiImplicitParam(name = "file",value = "文件",dataType = "MultipartFile",dataTypeClass = MultipartFile.class),
        @ApiImplicitParam(name = "updateSupport",value = "上传支持",dataType = "boolean",dataTypeClass = Boolean.class)
    })
